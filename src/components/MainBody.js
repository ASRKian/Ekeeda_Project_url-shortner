        ...
        <div className="outerDiv">
            <div className='mainBody'>
                <div className="innerBody">
                    ...
                    <p className="about">URL Shortner is a free tool to shorten a URL or reduce a link use our URL Shortner to create a shortned link making it easy to remember</p>
                </div>
            </div>
        </div>
    )
